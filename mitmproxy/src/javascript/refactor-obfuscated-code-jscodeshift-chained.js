...
const {StringArrayDecoderTransformer} = require("./refactor-obfuscated-code-jscodeshift-11");
...
class ChainedTransformer extends AstTransformer {
    ...
    performTransform() {
        ...
        debugger;
        ast = new StringArrayDecoderTransformer(11, ast, this.output, this.outputBaseName).transform();
