...
SITE_ROOT_PATH = 'sports', (ns_betslipstandarduilib_accessibility || (ns_betslipstandarduilib_accessibility = {})).BetslipCheckboxAccessibilityDelegate = class {
    ...
    t.RetainEachWayNoStake = false, e.StandardLocaleHelper = t;
    ...
    class o extends e {
        ...
        createChildren() {
            super.createChildren(), this.scrollable.addArrowButtonStyle('bss-OfferBadgesDesktopContainer_Arrows'), this.scrollable.addArrowButtonStyle('bss-OfferBadgesDesktopContainer_Hidden'), this.addStyle('bss-OfferBadgesDesktopContainer_Scroll'), this.buttonContainer.addStyle('bss-OfferBadgesDesktopContainer'), this.getElement().addEventListener('touchmove', e => {
                e.stopPropagation();
            }, { passive: true }), l.addMouseModeDelegate(this);
            var e, t, s = [], i = [];
            for (e of this.offersList)
    ...
    let m = n = class extends t {
            ...
            if (this.addStyle('bss-OfferBadgesPopup'), this.contentContainer = new r(), this.contentContainer.addStyle('bss-OfferBadgesPopup_ContentContainer'), this.staticContent)
                ...
                for (var e of this.stems) {
                    ...
                    a.setText(s), a.addStyle('bss-OfferBadgesPopup_Header'), this.contentContainer.appendChild(a), l.setText(i), l.addStyle('bss-OfferBadgesPopup_Text'), this.contentContainer.appendChild(l), this.linkLabel = new d(), this.linkLabel.setText(e), this.linkLabel.addStyle('bss-OfferBadgesPopup_Footer'), this.contentContainer.appendChild(this.linkLabel), this.linkLabel.clickHandler = () => {
                        var e;
                        t && ((e = u.AdditionalPreferences(b)).breadcrumbUrl = '', e.offerUrl = t, c.NavigateTo('#OF#', { data: { needsCard: false } }), this.parentElem.removeOfferTermsPopup());
                    };
                }
            super.createChildren(), this.appendChild(this.contentContainer), this.widthDelegate = new p(this, this.setTextPosition), o.currentApplication.addEventListener(h.WIDTH_CHANGED, this.widthDelegate), this.setTextPosition(), this.parentElem.setActive(true);
        }
        showPopup() {
            Locator.validationManager.callNewContext(() => {
        ...
        clickOutsideHandler(e) {
            this.popupHelper.hidePopup(), this.accessibility && this.accessibility.dispose(), Locator.validationManager.callPostValidation(() => {
                this.parentElem.removeOfferTermsPopup();
            }), this.parentElem.setActive(false);
        }
    ...
    let l = s = class extends e {
        constructor(e) {
            super(), this.offer = e, this.loading = false, this.cachedOffer = false;
        }
        buildTermsLink(e) {
        ...
        completeHandler(e, t, s, i) {
            this.loading = false, e && 200 === t && (a.ParseMessage(e, '#OFFER_TCS_' + s), this.getStemOfOffers(i, s));
        }
        filterOfferCodes(e) {
            var t, s = {};
            for (t of e)
        ...
        getStemOfOffers(e, t) {
            ...
            t && e.push(t.getChildren()[0]), e.length === this.offer.offerCodesTermsList.length && (this.createOfferTermsPopup(e), this.cachedOffer = true);
        }
    ...
    class d extends i {
        ...
        clickHandler() {
            var e;
            this.offerEPPopup ? this.removeOfferTermsPopup() : (e = this.offerEPPopup = new t(this, this.offer.offerText), this.appendChild(e), l.AddPopup(e, true, l.Root, false), l.AddDelegate(e));
        }
    ...
    class n extends t {
        ...
        removeOfferTermsPopup() {
            this.setActive(false), super.removeOfferTermsPopup();
        }
    }
    ...
    class s extends t {
        ...
        createChildren() {
            var e, t, s;
            this.offer && this.offer.offerCode && this.offer.offerText && (this.isSubOnOffer = false, this.addStyle('bss-OfferBadgeBetBuilder'), a.IsSubOn(this.offer.offerCode) && (this.isSubOnOffer = true), (e = a.GetBadgeTranslation(this.offer.offerCode, true)) ? this.isSubOnOffer ? (t = new l(), this.appendChild(t), t.addStyle('bss-OfferBadgeBetBuilder_OfferIconWrapper'), (s = new l('span')).addStyle('bss-OfferBadgeBetBuilder_OfferIcon'), t.appendChild(s)) : ((t = new i()).setText(e), this.appendChild(t), this.addStyle('bss-OfferBadgeBetBuilder-mini')) : ((s = new i()).setText(this.offer.offerText), this.appendChild(s)), super.createChildren());
        }
    }
    ...
    let n = class extends t {
        constructor(e, t, s, i) {
            super(), this.oddsVal = e, this.spSelected = t, this.target = s, this.delegate = i, this.oddsChanged = true, this.dropdownHelper = new a(this, s);
        }
        createChildren() {
        ...
        commitProperties() {
            this.oddsChanged && (this.oddsChanged = false, this.oddsLabel.setOdds(this.oddsVal, this.oddsTypeOverride));
        }
        showDropdown() {
            this.dropdownHelper.showDropDown(8, 4), this.isShowing = true;
        }
        hideDropdown() {
            this.isShowing && (this.dropdownHelper.hideDropDown(), this.isShowing = false);
        }
        setOdds(e, t) {
            this.oddsVal = e, this.oddsTypeOverride = t, this.oddsChanged = true, this.invalidateProperties();
        }
        disable() {
    ...
    let d = class extends t {
        constructor(e, t) {
            super(t), this.model = e, this.disabled = false, this.receiptMode = false;
        }
        createChildren() {
            this.addStyle('bsc-OddsDropdownLabel'), super.createChildren();
        }
        setOddsChanged() {
            this.disabled = true, this.addStyle('bsc-OddsDropdownLabel_OddsChanged'), this.dropdown && this.dropdown.hideDropdown(), super.setOddsChanged();
        }
        acceptOddsChange() {
            this.disabled = false, this.removeStyle('bsc-OddsDropdownLabel_OddsChanged'), super.acceptOddsChange();
        }
        clickHandler() {
        ...
        setStateForReceipt() {
            this.receiptMode = true, this.accessibility && this.accessibility.setDisabled();
        }
        revertReceiptState() {
            this.receiptMode = false, this.accessibility && this.accessibility.setDisabled();
        }
        static MakeAccessible(e) {
    ...
    let a = class extends t {
        ...
        setSelected() {
            this.isSelected = true, this.addStyle('bss-PitcherDropdownItem-selected'), this.delegate.pitcherDropdownItemSetSelected(this), this.accessibility && this.accessibility.clickHandler();
        }
        clickHandler(e) {
            this.isSelected || this.setSelected();
        }
        deselect() {
            this.isSelected = false, this.removeStyle('bss-PitcherDropdownItem-selected');
        }
        static MakeAccessible(e) {
            var t = {
    ...
    let l = class extends s {
        constructor(e, t, s, i, a) {
            super(), this.model = e, this.delegate = t, this.pitcherDescription = s, this.selectedPitcher = i, this.showDisclaimer = a, this.receiptMode = false;
        }
        createChildren() {
    ...
    let o = i = class extends a {
        constructor(e) {
            super(), this.delegate = e, this.isHidden = false, this.isDisabled = false, this.isSelected = false, this.defaultStyle = 'bsc-EachWayCheckbox', this.raceLookup = [
                '2',
                '4',
                '2030',
                '2031'
        ...
        setChecked() {
            this.addStyle(this.defaultStyle + '-checked'), this.isSelected = true, this.accessibility && this.accessibility.setChecked();
        }
        setUnchecked() {
            this.removeStyle(this.defaultStyle + '-checked'), this.isSelected = false, this.accessibility && this.accessibility.setChecked();
        }
        getChecked() {
        ...
        enableCheckbox() {
            this.isDisabled = false, this.removeStyle(this.defaultStyle + '-disabled'), this.accessibility && this.accessibility.setDisabled();
        }
        disableCheckbox() {
            this.isDisabled = true, this.addStyle(this.defaultStyle + '-disabled'), this.accessibility && this.accessibility.setDisabled();
        }
        hide() {
            this.wrapper.suspendElementFromDom(), t.HideElementTransition(this), this.isHidden = true;
        }
        show() {
            this.wrapper.unsuspendElementFromDom(), t.ShowElementTransition(this), this.isHidden = false;
        }
        static MakeAccessible(e) {
    ...
    let t = class extends i {
        constructor(e) {
            super(), this.delegate = e, this.isSelected = false, this.isDisabled = false;
        }
        createChildren() {
        ...
        setChecked() {
            this.addStyle('bsc-NoReservesCheckbox-checked'), this.isSelected = true, this.accessibility && this.accessibility.setChecked();
        }
        setUnchecked() {
            this.removeStyle('bsc-NoReservesCheckbox-checked'), this.isSelected = false, this.accessibility && this.accessibility.setChecked();
        }
        enableCheckbox() {
            this.isDisabled = false, this.removeStyle('bsc-NoReservesCheckbox-disabled'), this.accessibility && (this.accessibility.setDisabled(), this.accessibility.setHidden());
        }
        disableCheckbox() {
            this.isDisabled = true, this.addStyle('bsc-NoReservesCheckbox-disabled'), this.accessibility && (this.accessibility.setDisabled(), this.accessibility.setHidden());
        }
        static MakeAccessible(e) {
            var t = {
                isDisabled: () => e.isDisabled,
    ...
    let t = class extends i {
        ...
        setChecked() {
            this.addStyle('bsc-AutoVoidCheckbox-checked'), this.isSelected = true, this.accessibility && this.accessibility.setChecked();
        }
        setUnchecked() {
            this.removeStyle('bsc-AutoVoidCheckbox-checked'), this.isSelected = false, this.accessibility && this.accessibility.setChecked();
        }
        enableCheckbox() {
            this.isDisabled = false, this.removeStyle('bsc-AutoVoidCheckbox-disabled'), this.accessibility && this.accessibility.setDisabled();
        }
        disableCheckbox() {
            this.isDisabled = true, this.addStyle('bsc-AutoVoidCheckbox-disabled'), this.accessibility && this.accessibility.setDisabled();
        }
        static MakeAccessible(e) {
            var t = {
                isDisabled: () => e.isDisabled,
    ...
    let r = class extends t {
        constructor(e, t) {
            super(), this.model = e, this.delegate = t, this.oddsChange = false, this.suspendChange = false;
        }
        createChildren() {
        ...
        commitProperties() {
            var e;
            this.oddsChange && (this.oddsChange = false, this.model.setGlobalOdds(this.stem.data.OD), e = n.ApplyPriceVariance(this.stem.data.OD, {
            ...
            }), this.oddsLabel.setOdds(e), this.model.setOdds(e)), this.suspendChange && (this.suspendChange = false, '1' == this.stem.data.SU ? this.suspend() : this.unsuspend());
        }
        disable() {
            this.isDisabled = true, this.addStyle('bsc-EwexDropdownItem-disabled');
        }
        suspend() {
            this.model.suspended = true, this.addStyle('bsc-EwexDropdownItem-suspended');
        }
        unsuspend() {
            this.model.suspended = false, this.removeStyle('bsc-EwexDropdownItem-suspended');
        }
        subscriptionHandler(e) {
            this.stem = Locator.treeLookup.getReference(e.type), this.stem ? (this.stem.addDelegate(this), this.oddsChange = true, this.suspendChange = true, this.invalidateProperties()) : this.suspendElementFromDom();
        }
        stemUpdateHandler(e, t) {
            'OD' in t && (this.oddsChange = true), 'SU' in t && (this.suspendChange = true), this.invalidateProperties();
        }
        stemDeleteHandler(e) {
    ...
    let o = s = class extends i {
        constructor(e, t) {
            super(), this.model = e, this.delegate = t, this.isSelected = false, this.isDisabled = false;
        }
        createChildren() {
        ...
        setChecked() {
            this.model.isPopularBet() ? (this.accessibility && this.accessibility.setChecked(), this.isSelected = true, this.addStyle('bsc-EwexCheckbox-checkedpopularbet')) : (this.isSelected = true, this.addStyle('bsc-EwexCheckbox-checked'), this.accessibility && this.accessibility.setChecked());
        }
        setUnchecked() {
            this.model.isPopularBet() ? (this.accessibility && this.accessibility.setChecked(), this.isSelected = false, this.removeStyle('bsc-EwexCheckbox-checkedpopularbet')) : (this.isSelected = false, this.removeStyle('bsc-EwexCheckbox-checked'), this.accessibility && this.accessibility.setChecked());
        }
        getChecked() {
            return this.isSelected;
        }
        ...
        setCheckboxEnabled() {
            this.removeStyle('bsc-EwexCheckbox-disabled'), this.isDisabled = false, this.accessibility && this.accessibility.setDisabled();
        }
        setCheckboxDisabled() {
            this.addStyle('bsc-EwexCheckbox-disabled'), this.isDisabled = true, this.accessibility && this.accessibility.setDisabled();
        }
        showDropdown() {
    ...
    let e = class extends i {
        constructor(e = true, t = true) {
            super(), this.quickbetParent = e, this.modal = null, this.firstItemSelected = true, this._delegate_applicationWidthChangedHandler = null, this.voidEditClickHandler = e => {
        ...
        voidSelectionSelected() {
            this.selectionsWillVoidText.setText(a.GetTranslation('selectionVoid')), this.oddsRecalculatedText.setText(a.GetTranslation('oddsRecalculated')), this.firstItemSelected = true, this.fullSentence.setText(a.GetTranslation('selectionVoidRecalculated'));
        }
        voidEntireBetSelected() {
            this.selectionsWillVoidText.setText(a.GetTranslation('selectionStand')), this.oddsRecalculatedText.setText(a.GetTranslation('entireBetVoid')), this.firstItemSelected = false, this.fullSentence.setText(a.GetTranslation('selectionVoidWholeBetVoid'));
        }
        static MakeAccessible(e) {
    ...
    let L = class extends O {
        constructor(e, t) {
            super(), this.betslipComponentDelegate = t, this.isHidden = false, this.hasStake = false, this.liveAlertsActive = false, this.liveAlertsDisplayed = false, this.betCreditsInfoShowing = false, this.restrictedOdds = false, this.isSuperBoost = false, this.model = e;
        }
        createChildren() {
            ...
            var e = new a(), t = (e.addStyle('bss-NormalBetItem_Inner'), this.appendChild(e), this.liveAlertsTick = new a(), this.liveAlertsTick.addStyle('bss-NormalBetItem_LiveAlerts'), this.liveAlertsTick.clickHandler = () => {
                    this.liveAlertsDisplayed && (this.liveAlertsActive ? (this.liveAlertsTick.removeStyle('bss-NormalBetItem_LiveAlerts-active'), this.liveAlertsActive = false, this.liveAlertsAccessibility && this.liveAlertsAccessibility.setPressed(false)) : (this.liveAlertsTick.addStyle('bss-NormalBetItem_LiveAlerts-active'), this.liveAlertsActive = true, this.liveAlertsAccessibility && this.liveAlertsAccessibility.setPressed(true)), this.liveAlertsClickHandlerDelegate(this.liveAlertsActive));
        ...
        deleteContainerClickHandler() {
            this.swipeDelete.singleClick(true);
        }
        betBoostAvailable(e) {
            this.addStyle('bss-NormalBetItem_BetBoosted'), e !== C.SuperBoost && e !== C.HandicapSuperBoost && e !== C.InPlaySuperBoostSingle && e !== C.InPlaySuperBoostSingleHomepage || (this.isSuperBoost = true), e === C.SuperBoost && this.addStyle('bss-NormalBetItem_BetBoosted-super'), e === C.HandicapSuperBoost && this.addStyle('bss-NormalBetItem_BetBoosted-superhandicap'), this.betBoostText || this.model.getBetBoostType() === C.AccaBoost || this.model.getBetBoostType() === C.UnboostedBet || (this.betBoostText = new p(), this.betBoostText.addStyle('bss-NormalBetItem_BoostText'), this.marketContainer.appendChildAt(this.betBoostText, 0), this.setupBetBoostText());
        }
        setupBetBoostText() {
        ...
        displayMiniOfferBadges() {
            this.offerBadgesMiniLabel.setText(''), !B.BypassNoOffersCheck() && (b.IsExcludedFromPromotion('2') || b.IsExcludedFromOffers('2')) || B.Initialise(() => {
                ...
                for (e of B.GetLocaleOffersForBetslip(this.model.getOfferBadges()))
                    e.ot !== _.ACCUMULATOR_OFFER && ('EP' === e.oc ? s = true : B.IsSubOn(e.oc) ? i = true : (t = B.GetBadgeTranslation(e.oc, true)) && this.offerBadgesMiniLabel.setText(this.offerBadgesMiniLabel.getText() + ' ' + t));
        ...
        changeMinimumStakeAccepted() {
            this.stakeBox.invalidStake(false);
        }
        ...
        slipResultChanged(e) {
            ...
            case c.LineItemsAboveMaxStakesShortfallDeposit:
                this.stakeBox.invalidStake(true);
                break;
            case c.oddsBelowMinimum:
                this.restrictedOdds = true, this.stakeBox.addStyle('bss-NormalBetItem_HideStakeBox'), this.multiplesRestrictionChanged(true);
                break;
            case c.stakeAboveMinimum:
                this.stakeBox.invalidStake(false);
                break;
            case c.success:
                this.restrictedOdds = false;
            }
        ...
        showLiveAlertsTick() {
            this.liveAlertsDisplayed = true, this.liveAlertsActive && this.receiptMode && (this.addStyle('bss-NormalBetItem-livealerts'), this.liveAlertsTick.addStyle('bss-NormalBetItem_LiveAlerts-active'), this.liveAlertsAccessibility) && this.liveAlertsAccessibility.setPressed(true);
        }
        addLiveAlert() {
            this.liveAlertsActive = true, this.liveAlertsDisplayed && this.receiptMode && (this.addStyle('bss-NormalBetItem-livealerts'), this.liveAlertsTick.addStyle('bss-NormalBetItem_LiveAlerts-active'), this.liveAlertsAccessibility) && this.liveAlertsAccessibility.setPressed(true);
        }
        removeLiveAlert() {
            this.liveAlertsActive = false, this.liveAlertsTick.removeStyle('bss-NormalBetItem_LiveAlerts-active'), this.liveAlertsAccessibility && this.liveAlertsAccessibility.setPressed(false);
        }
        ...
        setStateForReceipt(e, t = false) {
            this.liveAlertsActive && (this.liveAlertsActive = false), this.betCreditsInfo && this.betCreditsInfo.setMessageForReceipt(), this.receiptMode = true, this.swipeDelete.disable(), !this.model.shouldExcludeFromReceipt() && (this.hasStake || e) || (d.HideElementTransition(this), this.isHidden = true), this.stakeBox && this.stakeBox.setStakeBoxForReceipt(), this.oddsLabel && this.oddsLabel.setStateForReceipt(), t || this.setReferralMaxStakeMessage(0), null != (e = this.redundantSelection) && e.setVisible(false);
        }
        revertReceiptState() {
            var e;
            this.receiptMode = false, this.removeStyle('bss-NormalBetItem_FullyDeclined'), this.liveAlertsDisplayed = false, this.removeStyle('bss-NormalBetItem-livealerts'), this.removeLiveAlert(), this.swipeDelete.enable(), this.betReference && (this.detailsWrapper.removeChild(this.betReference), this.betReference = null), this.stakeBox && (this.model.isSinglesRestricted() || this.stakeBox.enable(), this.stakeBox.revertReceiptStakeBox()), this.oddsLabel && this.oddsLabel.revertReceiptState(), null != (e = this.redundantSelection) && e.setVisible(this.isRedundant), this.isHidden && (d.ShowElementTransition(this), this.isHidden = false);
        }
        forceHide() {
            d.HideElementTransition(this), this.isHidden = true;
        }
        ...
        validateMinStakes(e) {
            ...
            0 != e && e < t ? (this.model.updateMinStakeInput(), this.stakeBox.invalidStake(true)) : (this.model.setAboveMinStake(e), this.stakeBox.invalidStake(false));
        }
        ...
        keypadRemoved() {
            this.swipeDelete.reset(), this.stakeBox.keypadRemoved(), this.removeStyle('bss-NormalBetItem-keypadopen'), this.deleteButton.keypadRemoved(), this.swipeDelete.setExcludeState(false);
        }
        betCreditsStakeChanged(e, t, s, i) {
            ...
            }), this.stakeBox.showNetReturn()), this.betCreditsInfoShowing = true) : this.betCreditsInfo && (d.HideElementTransition(this.betCreditsInfo, false, 0.2), this.freeBetTokenSelected || this.stakeBox.showToReturn(), this.betCreditsInfoShowing = false);
        }
        appendtoBet(e, t) {
        }
        getStake() {
        ...
        freeBetSelected() {
            this.freeBetTokenSelected = true, this.stakeBox.showNetReturn(), s.HideKeypad();
        }
        freeBetDeselected() {
            this.freeBetTokenSelected = false, this.stakeBox.showToReturn(), s.HideKeypad();
        }
        ...
        appendOfferBadges() {
            ...
            for (p of s)
                'EP' === p.oc ? l.push({
                    ...
                    offerCodesTermsList: [''],
                    offerType: _.NONE
                }) : B.IsBoreDraw(p.oc) ? r.push(p) : p.ot == _.SUB_ON_OFFER ? (h = true, d.push(p)) : p.ot == _.EARLY_PAYOUT_OFFER ? n.push(p) : p.oc == y.INCLUDED_EXTRA_TIME_OFFER || p.oc == y.NINETY_PLUS_STOPPAGE_TIME_OFFER ? o.push(p) : l.push({
                    offerCode: p.oc,
        ...
        static MakeAccessible(e) {
            ...
            t.makeAccessible(), e.liveAlertsActive && t.setPressed(true), e.swipeDeleteAccessibilityDelegate = new T(e.deleteButton, e.touchContainer, e), e.swipeDeleteAccessibilityDelegate.makeAccessible();
        }
        setInvalidState() {
        }
        clearInvalidState() {
    ...
    class l extends t {
        constructor() {
            super(...arguments), this.hiddenCheckbox = false;
        }
        createChildren() {
        ...
        revertReceiptState() {
            super.revertReceiptState(), this.hiddenCheckbox && (this.eachWayCheckbox.show(), this.hiddenCheckbox = false), this.eachWayCheckbox && this.eachWayCheckbox.enableCheckbox();
        }
        setAdditionalReceiptProperties() {
            !this.eachWayCheckbox || (this.hasStake || a.RetainEachWayNoStake) && this.eachWayCheckbox.getChecked() || (this.eachWayCheckbox.hide(), this.hiddenCheckbox = true);
        }
    }
    e.EachwayBetItem = l;
})(ns_betslipstandarduilib_ui_bet_standard = ns_betslipstandarduilib_ui_bet_standard || {}), (e => {
    ...
    class n extends e.NormalBetItem {
        ...
        revertReceiptState() {
            super.revertReceiptState(), this.hiddenCheckbox && (a.ShowElementTransition(this.eachWayCheckbox), this.hiddenCheckbox = false), this.eachWayCheckbox && this.eachWayCheckbox.enableCheckbox(), this.noReservesCheckbox && this.noReservesCheckbox.enableCheckbox();
        }
        setAdditionalReceiptProperties() {
            !this.eachWayCheckbox || (this.hasStake || l.RetainEachWayNoStake) && this.eachWayCheckbox.getChecked() || (a.HideElementTransition(this.eachWayCheckbox), this.hiddenCheckbox = true);
        }
    }
    ...
    class l extends e.NormalBetItem {
        constructor() {
            super(...arguments), this.hiddenCheckbox = false, this.disableVoidCheckbox = false;
        }
        createChildren() {
        ...
        autoVoidAvailableChanged(e, t, s) {
            e && !this.autoVoidCheckbox && (this.autoVoidCheckbox = new i(this), this.checkboxContainer.appendChild(this.autoVoidCheckbox), t || s ? (this.autoVoidCheckbox.setChecked(), s && (this.disableVoidCheckbox = true, this.autoVoidCheckbox.disableCheckbox())) : this.autoVoidCheckbox.setUnchecked());
        }
        ...
        revertReceiptState() {
            super.revertReceiptState(), this.hiddenCheckbox && (this.eachWayCheckbox.show(), this.hiddenCheckbox = false), this.autoVoidCheckbox && (this.disableVoidCheckbox ? this.autoVoidCheckbox.disableCheckbox() : this.autoVoidCheckbox.enableCheckbox()), this.eachWayCheckbox && this.eachWayCheckbox.enableCheckbox();
        }
        setAdditionalReceiptProperties() {
            !this.eachWayCheckbox || (this.hasStake || a.RetainEachWayNoStake) && this.eachWayCheckbox.getChecked() || (this.eachWayCheckbox.hide(), this.hiddenCheckbox = true);
        }
    ...
    class r extends t {
        constructor(e, t) {
            super(e, t), this.betslipComponentDelegate = t, this.hiddenCheckbox = false;
        }
        createChildren() {
        ...
        revertReceiptState() {
            super.revertReceiptState(), this.hiddenCheckbox && (a.ShowElementTransition(this.ewexCheckbox), this.hiddenCheckbox = false);
        }
        setAdditionalReceiptProperties() {
            !this.ewexCheckbox || (this.hasStake || n.RetainEachWayNoStake) && this.ewexCheckbox.getChecked() || (a.HideElementTransition(this.ewexCheckbox), this.hiddenCheckbox = true);
        }
        dispose() {
    ...
    class a extends t {
        ...
        pitcherChanged(t, s) {
            if (this.pitcherDetails)
                ...
                let e = true;
                t || (t = StandardLocaleHelper.GetTranslation('listedPitchers'), e = false), this.pitcherDetails = new i(this.model, this, t, s, e), this.additionalComponentsContainer.appendChild(this.pitcherDetails);
            }
        }
    ...
    class r extends s {
        constructor() {
            super(...arguments), this.showInfoButton = false, this.showMaxReturnText = false, this.hasFormatChanged = false, this.dropdownItemUpdated = e => {
        ...
        createChildren() {
            this.addStyle('bss-PositionPayoutBetItem'), super.createChildren(), this.locale = localeLib('BetslipStandardUILib'), this.oddsContainer && (this.oddsContainer.removeChild(this.oddsLabel), this.removeChild(this.oddsContainer)), this.oddsContainer = new t(), this.oddsContainer.addStyle('bss-PositionPayoutBetItem_OddsContainer'), this.oddsContentContainer = new t(), this.oddsContentContainer.addStyle('bss-PositionPayoutBetItem_OddsRightContainer'), this.oddsContentContainer.appendChildAt(this.oddsContainer, 1), this.oddsContentContainer.appendChild(this.stakeBox), this.stakeBox.addStyle('bss-PositionPayoutBetItem_StakeBox'), this.contentWrapper.appendChild(this.oddsContentContainer), this.contentWrapper.addStyle('bss-PositionPayoutBetItem_ContentWrapper'), this.detailsWrapper.setAttribute('class', 'bss-PositionPayoutBetItem_Details'), this.showInfoButton = true, this.showMaxReturnText = true, l.AddDelegate(this), n.App && n.App.watch('PositionPayoutModulePreferences', this.dropdownItemUpdated);
        }
        ...
        setStateForReceipt(e, t = false) {
            super.setStateForReceipt(e, t), this.placeMultipliersFormat !== a.CurrencyFormat || this.model.getStake() || (this.hasFormatChanged = true, this.positionPayoutoddsLabel.setMultipliersFormat(a.Multiplierformat)), this.stakeBox.suspendElementFromDom();
        }
        revertReceiptState() {
            super.revertReceiptState(), this.hasFormatChanged && (this.hasFormatChanged = false, this.positionPayoutoddsLabel.setMultipliersFormat(this.placeMultipliersFormat)), this.stakeBox.unsuspendElementFromDom();
        }
        dispose() {
    ...
    let d = class extends i {
        constructor(e, t) {
            super(), this.parentElem = e, this.firstSelectionSelected = t, this.popupHelper = new a(this, this.parentElem.chevron, this, true);
        }
        createChildren() {
            this.addStyle('bss-PlayerVoidModal');
            var e = new i(), t = (e.addStyle('bss-PlayerVoidModal_Wrapper'), this.appendChild(e), new s()), t = (t.setText(l.GetTranslation('playerDoesntStart')), t.addStyle('bss-PlayerVoidModal_TitleText'), e.appendChild(t), this.firstSelection = new i(), this.firstSelection.clickHandler = () => this.playerVoidSelectedClickHandler(true), this.firstSelection.addStyle('bss-PlayerVoidModal_FirstSelection'), new i()), t = (t.addStyle('bss-PlayerVoidModal_FirstSelection-icon1'), this.firstSelection.appendChild(t), new s()), t = (t.addStyle('bss-PlayerVoidModal_SelectionText'), t.setText(l.GetTranslation('selectionVoidRecalculated')), this.firstSelection.appendChild(t), this.secondSelection = new i(), this.secondSelection.clickHandler = () => this.playerVoidSelectedClickHandler(false), this.secondSelection.addStyle('bss-PlayerVoidModal_SecondSelection'), new i()), t = (t.addStyle('bss-PlayerVoidModal_FirstSelection-icon2'), this.secondSelection.appendChild(t), new s());
    ...
    let l = class extends a {
        ...
        mouseModeEnabled() {
            this.mouseMode = true, this.accessibility && this.accessibility.setHidden(false);
        }
        mouseModeDisabled() {
            this.mouseMode = false, this.accessibility && this.accessibility.setHidden(true);
        }
        dispose() {
            i.removeMouseModeDelegate(this);
        }
        static MakeAccessible(e) {
            e.accessibility = new t(e, s.GetTranslation('delete')), e.accessibility.makeAccessible(), e.mouseMode || e.accessibility.setHidden(true);
        }
    };
    ...
    let H = a = class extends c {
        constructor(e, t) {
            super(), this.delegate = t, this.isPositionPayout = false, this.stakeBoxType = s, this.checkboxHidden = false, this.isHidden = false, this.hasStake = false, this.isCast = false, this.multiplesExpanded = false, this.isExpandedState = false, this.isStateChanged = false, this.autoVoidEnabled = false, this.betCreditsInfoShowing = false, this.model = e;
        }
        createChildren() {
            var e = Locator.user.languageId || '1', t = (this.restrictedSelections = ns_sitepreferenceslib_util.UserPreferences.AdditionalPreferences(ns_betslipcorelib_util.BetslipPreferences).containsRestrictedSelections, this.addStyle('bss-MultipleHeader'), this.wrapper = new c()), s = (t.addStyle('bss-MultipleHeader_Outer-wrapper'), this.appendChild(t), new c()), i = (s.addStyle('bss-MultipleHeader_DeleteContainer'), t.appendChild(s), this.innerWrapper = new c(), this.innerWrapper.addStyle('bss-MultipleHeader_Wrapper'), this.appendChild(this.innerWrapper), this.deleteButton = new k(this, true), s.appendChild(this.deleteButton), s.clickHandler = () => this.deleteContainerClickHandler(), s.appendChild(this.innerWrapper), this.touchContainer = new c(), this.touchContainer.addStyle('bss-MultipleHeader_Content'), this.innerWrapper.appendChild(this.touchContainer), this.touchContainer.appendChildAt(new E(this), 0), this.touchContainer.clickHandler = () => {
            ...
            null !== e ? (this.isPositionPayout = true, this.oddsLabel = new r(false, false, {}, e), this.oddsLabel.addStyle('bss-MultipleHeader_OddsLabel'), this.oddsContainer.appendChild(this.oddsLabel), this.oddsLabelExpanded = new r(false, false, {}, e)) : (this.oddsLabel = new n(), this.oddsLabel.showSPText = false, this.oddsLabel.addStyle('bss-MultipleHeader_OddsLabel'), this.oddsContainer.appendChild(this.oddsLabel), this.oddsLabelExpanded = new n(), this.oddsLabelExpanded.showSPText = false), this.oddsLabelExpanded.defaultStyle = 'bsc-OddsLabel', this.oddsContainerExpanded.appendChild(this.oddsLabelExpanded), this.bottomSection = new d(), this.bottomSection.setAttribute('class', 'bss-MultipleHeader_BottomSection'), this.multipleDetails.appendChild(this.bottomSection), this.underWrapper = new c(), this.underWrapper.addStyle('bss-MultipleHeader_UnderWrapper'), this.toggleWrapper = new c(), this.toggleWrapper.addStyle('bss-MultipleHeader_ToggleWrapper');
            let a = () => {
                0 == this.delegate.multipleHeaderGetMultiplesCount() || this.disabled || (this.expandMultiplesChanged = true, this.invalidateProperties());
            };
        ...
        commitProperties() {
            this.isStateChanged && (this.isStateChanged = false, this.setAutoVoidMessage(this.isExpandedState)), this.changeMultipleHeader();
        }
        ...
        changeMultipleHeader() {
            this.expandMultiplesChanged && (this.expandMultiplesChanged = false, this.multiplesExpanded ? this.delegate.multipleHeaderCollapseMultiples() : this.delegate.multipleHeaderExpandMultiples(), this.multiplesExpanded = !this.multiplesExpanded);
        }
        slipResultChanged(e) {
            switch (e) {
            ...
            case b.lineItemsBelowMinimumShortOddsStake:
                0 < this.model.getStake() && this.stakeBox.invalidStake(true);
                break;
            case b.success:
        ...
        disable() {
            this.disabled = true, this.addStyle('bss-MultipleHeader_Disabled'), this.hideMoreMultiplesButton(), this.stakeBox.disable();
        }
        enable(e) {
            this.disabled = false, this.removeStyle('bss-MultipleHeader_Disabled'), this.showMoreMultiplesButton(), this.stakeBox.enable(e);
        }
        betTypeChanged(e) {
        ...
        oddsUpdated(e, t, s) {
            if ('' == (e = '0/1' == e ? '' : e) ? (this.addStyle('bss-MultipleHeader_NoOdds'), this.oddsAvailable = false) : (this.removeStyle('bss-MultipleHeader_NoOdds'), this.oddsAvailable = true), this.isPositionPayout) {
                let e = this.model.getOdds();
                return e ? (i = D.FormatOdds(e, '', R.DECIMAL), i = parseFloat(i) + '', this.oddsLabel.setOdds(i + a.MULTIPLIER_SUFFIX), this.oddsLabelExpanded.setOdds(i + a.MULTIPLIER_SUFFIX), void this.stakeBox.showMaxReturn()) : undefined;
            }
        ...
        setStateForReceipt(e = false) {
            this.swipeDelete.disable(), this.hasStake || this.isHidden || (h.HideElementTransition(this), this.isHidden = true), this.betCreditsInfo && this.betCreditsInfo.setMessageForReceipt(), this.eachWayCheckbox && !this.eachWayCheckbox.getChecked() && (h.HideElementTransition(this.eachWayCheckbox), this.checkboxHidden = true), this.eachWayCheckbox && this.eachWayCheckbox.disableCheckbox(), this.stakeBox && this.stakeBox.setStakeBoxForReceipt(), e || this.setReferralMaxStakeMessage(0), this.addStyle('bss-MultipleHeader-reciept');
        }
        revertReceiptState() {
            this.removeStyle('bss-MultipleHeader_FullyDeclined'), this.removeStyle('bss-MultipleHeader_Referred'), this.swipeDelete.enable(), this.betReference && (this.bottomSection.removeChild(this.betReference), this.betReference = null, this.removeStyle('bss-MultipleHeader_HasBetRef')), this.checkboxHidden && this.eachWayCheckbox && (h.ShowElementTransition(this.eachWayCheckbox), this.checkboxHidden = false), this.eachWayCheckbox && this.eachWayCheckbox.enableCheckbox(), this.stakeBox && this.stakeBox.revertReceiptStakeBox(), this.referralInfoContainer && (this.referralInfoContainer.removeAllChildren(), this.wrapper.removeChild(this.referralInfoContainer), this.referralInfoContainer.suspendElementFromDom()), this.removeStyle('bss-MultipleHeader-reciept'), this.isHidden && (h.ShowElementTransition(this), this.isHidden = false);
        }
        stakeChanged(e) {
        ...
        betCreditsStakeChanged(e, t) {
            ...
            }), this.stakeBox.showNetReturn()), this.betCreditsInfoShowing = true) : this.betCreditsInfo && (h.HideElementTransition(this.betCreditsInfo, false, 0.2), this.stakeBox.showToReturn(), this.betCreditsInfoShowing = false);
        }
        ewAvailableChanged(e, t) {
        ...
        setAutoVoidState(e) {
            this.autoVoidEnabled = e, this.isStateChanged = true, this.invalidateProperties();
        }
        ...
        switchToCondensedView() {
            this.swipeDelete.enable(), this.offerBadgesContainer && this.offerBadgesContainer.showOfferBadge(), this.isExpandedState = false, this.touchContainer.removeStyle('bss-MultipleHeader_Content-expanded'), this.referralMessageContainer && this.referralMessageContainer.addStyle('bss-MultipleHeader_Referred-hide'), this.isStateChanged = true, this.invalidateProperties();
        }
        switchToExpandedView() {
            this.swipeDelete.reset(), this.swipeDelete.disable(), this.offerBadgesContainer && this.offerBadgesContainer.hideOfferBadge(), this.isExpandedState = true, this.touchContainer.addStyle('bss-MultipleHeader_Content-expanded'), this.referralMessageContainer && this.referralMessageContainer.removeStyle('bss-MultipleHeader_Referred-hide'), this.isStateChanged = true, this.invalidateProperties();
        }
    ...
    class s extends t {
        constructor(e, t) {
            super(), this.model = e, this.delegate = t, this.description = '', this.handicap = '', this.excluded = false;
        }
        createChildren() {
            super.createChildren(), this.addStyle('bsc-MiniBetItem'), this.model.addMiniBetDelegate(this);
        }
        betSlipDisplayChanged(e) {
            this.description = e, this._text = this.formatDescription(), this._textChanged = true, this.invalidateProperties();
        }
        miniBetHandicapChanged(e) {
            this.handicap = e = e && '' !== e ? ' ' + e : e, this._text = this.formatDescription(), this._textChanged = true, this.invalidateProperties();
        }
    ...
    let L = class extends R {
        constructor(e, t) {
            super(), this.betslipComponentDelegate = t, this.playerVoidSentence = null, this.hasStake = false, this.isHidden = false, this.betCreditsInfoShowing = false, this.isSuperBoost = false, this.model = e;
        }
        createChildren() {
        ...
        clickHandler() {
            false === H.getIsMultipleOffersContainerExpanded() ? this.isSuspended || this.betslipComponentDelegate.betBuilderBetItemShowOptions() : H.setIsMultipleOffersContainerExpanded(false);
        }
        removeButtonClickHandler() {
        ...
        appendPlayerVoidsSentence(e) {
            this.playerVoidSentence || (this.playerVoidSentence = new C(false, e), this.content.appendChild(this.playerVoidSentence), this.addStyle('bss-BetBuilderBetItem_HasPlayerVoid'));
        }
        ...
        betBoostAvailable(e) {
            this.addStyle('bss-BetBuilderBetItem_BetBoosted'), e !== B.BetBuilderSuperBoost && e !== B.BetBuilderPopularSuperBoost && e !== B.InPlaySuperBoostBetBuilder && e !== B.InPlaySuperBoostBetBuilderHomepage || (this.isSuperBoost = true, this.addStyle('bss-BetBuilderBetItem_BetBoosted-super'));
        }
        setupBetBoostedOdds(e, t, s, i) {
        ...
        suspend() {
            this.isSuspended = true, this.addStyle('bss-BetBuilderBetItem_Suspended');
        }
        unsuspend() {
            this.isSuspended = false, this.removeStyle('bss-BetBuilderBetItem_Suspended');
        }
        fixtureDescriptionChanged(e) {
            this.fixtureLabel.setText(e);
        }
        ...
        setStateForReceipt(e, t = false) {
            this.swipeDelete.disable(), !this.model.shouldExcludeFromReceipt() && (this.hasStake || e) || (h.HideElementTransition(this), this.isHidden = true), this.betCreditsInfo && this.betCreditsInfo.setMessageForReceipt(), this.stakeBox && this.stakeBox.setStakeBoxForReceipt(), t || this.setReferralMaxStakeMessage(0);
        }
        revertReceiptState() {
            this.swipeDelete.enable(), this.betReference && (this.additionalComponentsContainer.removeChild(this.betReference), this.betReference = null), this.stakeBox && (this.model.isSinglesRestricted() || this.stakeBox.enable(), this.stakeBox.revertReceiptStakeBox()), this.isHidden && (h.ShowElementTransition(this), this.isHidden = false);
        }
        referralAmountChanged(e, t) {
        ...
        showKeypad() {
            this.addStyle('bss-BetBuilderBetItem_Keypad'), t.ShowKeypad(this.topSectionWrapper, this, this.model.key(), 'bss-Keypad'), this.swipeDelete.setExcludeState(true), this.swipeDelete.setExcludeElement(this.stakeBox.getElementContainer());
        }
        createKeyPad() {
            return localeLib('BetslipStandardUILib').createBetItemKeypad(this, 'bss-Keypad');
        }
        ...
        hideKeypad() {
            t.HideKeypad(), this.swipeDelete.setExcludeState(false);
        }
        itemClicked(e) {
            this.swipeDelete.reset(), this.stakeBox.itemClicked(e);
        }
        ...
        betCreditsStakeChanged(e, t, s, i) {
            e ? (this.betCreditsInfo || (this.betCreditsInfo = new _(), this.betCreditsInfo.suspendElementFromDom(), this.betCreditsInfo.addStyle('bss-BetBuilderBetItem_BetCredits'), this.additionalComponentsContainer.appendChildAt(this.betCreditsInfo, 0)), this.betCreditsInfo.setBetCreditsStake(e, t, y.USING, s, i), this.betCreditsInfoShowing || (Locator.validationManager.callLater(() => {
                h.ShowElementTransition(this.betCreditsInfo, null, 0.2);
            }), this.stakeBox.showNetReturn()), this.betCreditsInfoShowing = true) : this.betCreditsInfo && (h.HideElementTransition(this.betCreditsInfo, false, 0.2), this.freeBetTokenSelected || this.stakeBox.showToReturn(), this.betCreditsInfoShowing = false);
        }
        freeBetSelected() {
            this.freeBetTokenSelected = true, this.stakeBox.showNetReturn(), t.HideKeypad();
        }
        freeBetDeselected() {
            this.freeBetTokenSelected = false, this.stakeBox.showToReturn(), t.HideKeypad();
        }
        multiplesRestrictionChanged(e) {
        ...
        setAutoVoidSelected(e) {
            e.stopPropagation = true, this.participantModel.setAutoVoid(e.selection);
        }
        getBetModel() {
            return this.model;
        }
    ...
    let y = a = class extends l {
        constructor(e, t) {
            super(), this.delegate = t, this.stakeBoxType = s, this.checkboxHidden = false, this.isHidden = false, this.hasStake = false, this.isCast = false, this.betCreditsInfoShowing = false, this.model = e;
        }
        createChildren() {
        ...
        setStateForReceipt() {
            this.isCast && this.addStyle('bss-MultipleItem_CastReceipt'), this.hasStake || (this.delegate.multiplesExpanded ? h.HideElementTransition(this) : this.suspendElementFromDom(), this.isHidden = true), this.betCreditsInfo && this.betCreditsInfo.setMessageForReceipt(), this.eachWayCheckbox && !this.eachWayCheckbox.getChecked() && (h.HideElementTransition(this.eachWayCheckbox), this.checkboxHidden = true), this.stakeBox && this.stakeBox.setStakeBoxForReceipt(), this.setReferralMaxStakeMessage(0);
        }
        revertReceiptState() {
            this.removeStyle('bss-MultipleItem_FullyDeclined'), this.removeStyle('bss-MultipleItem_CastReceipt'), this.betReference && (this.bottomSection.removeChild(this.betReference), this.betReference = null), this.isHidden && (this.delegate.multiplesExpanded ? h.ShowElementTransition(this) : this.unsuspendElementFromDom(), this.isHidden = false), this.checkboxHidden && this.eachWayCheckbox && (h.ShowElementTransition(this.eachWayCheckbox), this.checkboxHidden = false), this.stakeBox && this.stakeBox.revertReceiptStakeBox();
        }
        betCountUpdated(e) {
    ...
    y.ShowPermedReturnsOnSlip = false, y.SINGLES_MULTIPLE_ITEM_ID = -1, y = a = __decorate([AccessibilityDelegate(y)], y), e.MultipleItem = y;
                ...
                if (this.getElement().scrollHeight > this.getElement().clientHeight) {
                    ...
                    for (; 0 < e;) {
                        if (!this.miniBetsList[e].hidden) {
                            this.miniBetsList[e].item.getElement().style.display = 'none', this.miniBetsList[e].hidden = true, t++;
                            break;
                        }
                        e--;
                    }
                    ...
                    0 < e.addedNodes.length && 0 < t && (this.miniBetsList[this.miniBetsList.length - 1].item.getElement().style.display = 'none', this.miniBetsList[this.miniBetsList.length - 1].hidden = true, t++), this.moreTextnode.setText('+' + t), 0 == t && (this.moreSelections.getElement().style.opacity = '0', this.moreSelections.getElement().style.display = 'none');
            }
            var t;
                    ...
                    if (0 < e) {
                        for (var s of this.miniBetsList)
                            if (s.hidden && !s.item.getExcludedState()) {
                                s.item.getElement().style.removeProperty('display'), s.hidden = false, 0 < --e ? (this.moreTextnode.setText('+' + e), this.moreSelections.getElement().style.opacity = '1', this.moreSelections.getElement().style.display = 'flex') : this.moreSelections.getElement().style.opacity = '0';
                                break;
                            }
                    } else
    ...
    let p = t = class extends s {
        constructor(e, t) {
            super(), this.preselected = e, this.delegate = t, this.selected = false, this.suspended = false, this.disableBetCredit = true, this.isSelected = false, this.isDisabled = false, this.messageType = h.BetCreditsHeader;
        }
        isMessageMatched(e) {
        ...
        checked() {
            this.selected = true, this.checkBox.addStyle('bsc-BetCreditsHeader_CheckBox-selected'), this.accessibility && this.accessibility.setChecked();
        }
        unChecked() {
            this.selected = false, this.checkBox.removeStyle('bsc-BetCreditsHeader_CheckBox-selected'), this.accessibility && this.accessibility.setChecked();
        }
        ...
        hideBetCreditsHeader() {
            this.canShow = false, this.selected && this.checkBox.removeStyle('bsc-BetCreditsHeader_CheckBox-selected'), this.addStyle('bsc-BetCreditsHeader_Hide'), this.accessibility && this.accessibility.setHidden();
        }
        reset() {
            this.selected && this.updateStatus(!this.selected), this.balanceUpdateHandler();
        }
        disable() {
            this.selected && (this.selected = false, this.checkBox.removeStyle('bsc-BetCreditsHeader_CheckBox-selected')), this.isDisabled = true, this.addStyle('bsc-BetCreditsHeader-disabled'), this.accessibility && this.accessibility.setDisabled();
        }
        enable() {
            this.removeStyle('bsc-BetCreditsHeader-disabled'), this.isDisabled = false, this.accessibility && this.accessibility.setDisabled();
        }
        dispose() {
    ...
    class i extends t {
        constructor(e) {
            super(), this.slipuidelegate = e, this.showing = false;
        }
        createChildren() {
        ...
        setCreditMessageText(e, t, s, i = false) {
        ...
        setMessage(e, t, s, i, a) {
            ...
            return l ? (s && a && i ? l = (l = (l = l.replace('{0}', n.ApplyDelimiterAndGroupSeparator(s))).replace('{1}', n.ApplyCurrencySymbol(n.ApplyDelimiterAndGroupSeparator(i)))).replace('{2}', n.ApplyCurrencySymbol(n.ApplyDelimiterAndGroupSeparator(a))) : s && a ? l = (l = l.replace('{0}', n.ApplyDelimiterAndGroupSeparator(s))).replace('{1}', n.ApplyCurrencySymbol(n.ApplyDelimiterAndGroupSeparator(a))) : s ? (l = l.replace('{0}', n.ApplyDelimiterAndGroupSeparator(s)), i && (l = l.replace('{1}', n.ApplyCurrencySymbol(n.ApplyDelimiterAndGroupSeparator(i))))) : a ? (l = l.replace('{0}', n.ApplyDelimiterAndGroupSeparator(a)), i && (l = l.replace('{1}', n.ApplyCurrencySymbol(n.ApplyDelimiterAndGroupSeparator(i))))) : l = '', this.betCreditTotalDetails.commitText(l), this.betCreditReturns.commitText(StandardLocaleHelper.GetTranslation(t)), this.showing || (this.slipuidelegate.betCreditsMessageShowOnSlipWithResize(this), this.showing = true)) : (this.slipuidelegate.betCreditsMessageHideFromSlipWithResize(this), this.showing = false), this.showing;
        }
        setReceiptCreditMessageText() {
            this.values && this.setCreditMessageText(this.values[0], this.values[1], this.values[2], true);
        }
    }
    ...
    class b extends ns_betslipuilib_ui_footer.Footer {
        constructor(e, t) {
            super(), this.betslipModel = e, this.slipUiDelegate = t, this.defaultStyle = 'bss-Footer', this.emptyStakeCount = 0, this.showingRestricedMessage = false, this.rememberedStake = '0', this.currentStake = '0', this.locale = localeLib('BetslipStandardUILib');
        }
        createChildren() {
        ...
        stakeBoxShowKeypad() {
            o.ShowKeypad(this, this, 'bsf'), this.slipUiDelegate.footerSetKeypadState(true);
        }
        createKeyPad() {
            return this.locale.createFooterKeypad(this, 'bsf');
        }
        stakeBoxHideKeypad() {
            this.slipUiDelegate.footerSetKeypadState(false);
        }
        stakeBoxStakeCleared() {
            this.stakeBox.setEmpty(), this.stakeBox.invalidStake(false);
        }
        ...
        getStakeTaxUser() {
            var e;
            return null == (e = this.betModel) ? undefined : e.getStakeTaxUser();
        }
        ...
        doneClicked() {
            this.stakeBox.doneClicked(), this.slipUiDelegate.footerSetKeypadState(false);
        }
        deleteClicked() {
            this.stakeBox.deleteClicked();
        }
        keypadRemoved() {
            this.stakeBox.keypadRemoved(), this.slipUiDelegate.footerSetKeypadState(false);
        }
        ...
        hideKeypad() {
            o.HideKeypad(), this.slipUiDelegate.footerSetKeypadState(false);
        }
        swipeDeleteBet() {
            c.HideElementTransition(this, false, 0.25, () => {
                Locator.validationManager.callLater(() => {
        ...
        switchToCondensedView() {
            this.betWrapper.switchToCondensedView(), u.setHasFooterStake(true);
        }
        switchToExpandedView() {
            this.betWrapper.switchToExpandedView(), u.setHasFooterStake(false);
        }
        selectionsChanged(e) {
    ...
    let t = s = class extends i {
        ...
        createChildren() {
            ...
            e.addStyle('bss-BetTrackBannerReact_Button'), this.betTrackButtonText = new a(), this.betTrackButtonText.setText(StandardLocaleHelper.GetTranslation('track')), e.appendChild(this.betTrackButtonText), this.checkMark = new i(), this.checkMark.setVisible(false), this.checkMark.addStyle('bss-BetTrackBannerReact_Checkmark'), e.appendChild(this.checkMark), this.tooltipContainer = new i(), this.tooltipContainer.addStyle('bss-BetTrackBannerReact_TooltipContainer'), this.tooltipContainer.setVisible(false), this.tooltipMessage = new a(), this.tooltipMessage.addStyle('bss-BetTrackBannerReact_TooltipText'), this.tooltipContainer.appendChild(this.tooltipMessage), e.appendChild(this.tooltipContainer), e.clickHandler = () => {
                var e;
        ...
        betslipBetsDataConverter(t, s) {
            ...
            if (t || s) {
                ...
                for (a of e) {
                    var n = a.bb || false, r = a.nf, d = [], o = a.pt, h = o[0];
                    if (n)
                        for (var p of o)
                            d.push({
                                participantId: p.pi,
        ...
        getOfferBadges(e, t) {
            ...
            for (i of t) {
                ...
                for (let t of e)
                    t.oc && !l.some(e => e.code === t.oc) && (r.IsAccumulator(t.oc) ? (a = !(a = this.slip.getDefaultMultiple()) || null == (a = a.ap) ? undefined : a.toString(), l.push({
                        code: t.oc,
                        bonus: a ? '+' + a + '%' : undefined
                    })) : l.push({ code: t.oc }));
            }
    ...
    let L = d = class extends l {
        constructor(e, t = null) {
            super(), this.delegate = e, this.defaultStyle = 'bss-StandardBetslip', this.bets = [], this.castBets = [], this.multiples = [], this.multiplesExpanded = false, this.multiplesSuspended = false, this.disposed = false, this.castMultiples = 0, this.removeAllClicked = false, this.invalidStakeResultCount = 0, this.betslipState = x.BetslipStateNone, this.slipTypeChanged = false, this.model = t || this.createStandardSlip();
        }
        ...
        restoreEditMode(e) {
            e ? (this.removeStyle('bss-StandardBetslip_EditModeNotActive'), this.addStyle('bss-StandardBetslip_EditMode'), this.controlBar && this.controlBar.setEditMode(), this.editModeActive = true, this.setPluginBetItemsToEditMode()) : (this.addStyle('bss-StandardBetslip_EditModeNotActive'), this.removeStyle('bss-StandardBetslip_EditMode'), this.controlBar && this.controlBar.removeEditMode(), this.removePluginBetItemsFromEditMode(), this.editModeActive = false);
        }
        restoreKeypad(e) {
            if (e) {
        ...
        restoreBetCreditState(e) {
            this.betCreditsModeActive = e, this.betCreditsModeChanged = true;
        }
        createChildren() {
            ...
            var e = {
                    ...
                    slipHeaderCloseClicked: () => {
                        ...
                        }), this.editModeActive && (this.removeStyle('bss-StandardBetslip_EditMode'), this.addStyle('bss-StandardBetslip_EditModeNotActive'), this.controlBar && this.controlBar.removeEditMode(), this.editModeActive = false), this.betslipState == x.BetslipStateExpanded ? this.delegate.standardBetslipMinimise() : (this.delegate.standardBetslipShowOverlay(0 < g.GetBetCount(), false), this.multipleHeader && this.multipleHeader.switchToExpandedView(), this.footer && this.footer.switchToExpandedView(), this.animationHelper.collapsedToExpandedView(), this.messageManager.updateDisplayState(x.BetslipStateExpanded), this.setSlipDisplayState(x.BetslipStateExpanded), this.initialResize());
                    },
                    slipHeaderDoneClicked: () => {
                        this.delegate.standardBetslipCollapse(), this.clearCouponHighlighting(), this.removeAllClicked = true, this.model.removeAllItems(), this.removeRemainingStakeLimitContainer(), this.dispose();
                    },
                    ...
                    controlBarRemoveAllClicked: () => {
                        ...
                        }), this.removeAllClicked = true, this.removeErrorMessage(), this.model.removeAllItems(), this.delegate.standardBetslipHideOverlay(), this.editModeChanged = true, this.invalidateProperties();
                    },
                    ...
                    betCreditsHeaderChecked: () => {
                        this.betCreditsModeActive = true, this.betCreditsModeChanged = true, this.footer.toggleBonusValue('0'), this.betCreditsHeader.checked(), this.invalidateProperties(), this.model.normalBetInvalidateStakes();
                    },
                    betCreditsHeaderUnchecked: () => {
                        this.betCreditsModeActive = false, this.betCreditsModeChanged = true, this.betCreditsHeader.unChecked(), this.invalidateProperties(), this.model.normalBetInvalidateStakes();
                    }
                }), s = (this.expandedHeaderWrapper = new l(), this.expandedHeaderWrapper.addStyle('bss-StandardBetslip_ContentHeader'), this.betCreditsModeActive = g.GetUseBetCredits(), this.betCreditsHeader = new $(this.betCreditsModeActive, s), t.appendChild(this.expandedHeaderWrapper), this.offerBadgesWrapper = new l(), this.offerBadgesWrapper.addStyle('bss-StandardBetslip_OfferBadgesContainer'), t.appendChild(this.offerBadgesWrapper), n.ScrollWrapper = e, this.setHasSingles(true), n.ContentWrapper = this.contentArea, this.selectionContainerTop = new l(), this.selectionContainerTop.addStyle('bss-StandardBetslip_SelectionTop'), t.appendChild(this.selectionContainerTop), new l());
            s.addStyle('bss-StandardBetslip_TopContainer'), t.appendChild(s), this.betBuilderLogoWrapper = new S(), this.betBuilderLogoWrapper.setAttribute('class', 'bss-StandardBetslip_BetBuilderLogoWrapper'), s.appendChild(this.betBuilderLogoWrapper), this.betBuilderLogo = new K(false), this.betBuilderLogoWrapper.appendChild(this.betBuilderLogo), this.betBuilderDivider = new S(), t.appendChild(this.betBuilderDivider), this.betBuilderDivider.suspendElementFromDom(), this.singleDivider = new S(), t.appendChild(this.singleDivider), this.singleDivider.suspendElementFromDom(), this.castDivider = new S(), t.appendChild(this.castDivider), this.castDivider.suspendElementFromDom(), this.multiplesDivider = new S(), t.appendChild(this.multiplesDivider), this.multiplesDivider.suspendElementFromDom(), this.selectionContainerBottom = new l(), this.selectionContainerBottom.addStyle('bss-StandardBetslip_SelectionBottom'), t.appendChild(this.selectionContainerBottom), this.exSelectionContainerTop = new l(), this.exSelectionContainerTop.addStyle('bss-StandardBetslip_ExSelectionTop'), t.appendChild(this.exSelectionContainerTop), this.exSelectionContainerTop.setVisible(false), this.excludedSngleDivider = new S(), this.excludedSngleDivider.setAttribute('class', 'test'), t.appendChild(this.excludedSngleDivider), this.excludedSngleDivider.suspendElementFromDom(), this.exSelectionContainerBottom = new l(), this.exSelectionContainerBottom.addStyle('bss-StandardBetslip_EXSelectionBottom'), t.appendChild(this.exSelectionContainerBottom), this.exSelectionContainerBottom.setVisible(false), this.footer = this.createFooter(), this.appendChild(this.footer), this.header.getElement().addEventListener('touchmove', e => {
                e.preventDefault(), e.stopPropagation();
            }), this.footer.getElement().addEventListener('touchmove', e => {
                e.preventDefault(), e.stopPropagation();
            }), (this.model.getBetCount() || g.GetBetCount()) && this.editModeActive && (this.editModeActive = false, this.removeStyle('bss-StandardBetslip_EditMode'), this.addStyle('bss-StandardBetslip_EditModeNotActive'), this.controlBar && this.controlBar.removeEditMode(), this.editModeActive = false), this.invalidateHeight = true, this.setModelDelegate(), this.documentResizeHandler = new J(this, () => {
                Locator.validationManager.callNewContext(() => {
        ...
        checkValidBetTrackID() {
            ...
            return 0 < (null == a ? undefined : a.re) && i.push(a), 0 != i.filter(e => {
                var t;
        ...
        commitProperties() {
            this.editModeChanged ? (this.editModeChanged = false, this.editModeActive ? (this.removeStyle('bss-StandardBetslip_EditMode'), this.addStyle('bss-StandardBetslip_EditModeNotActive'), this.controlBar && this.controlBar.removeEditMode(), this.removePluginBetItemsFromEditMode(), this.editModeActive = false) : (this.addStyle('bss-StandardBetslip_EditMode'), this.removeStyle('bss-StandardBetslip_EditModeNotActive'), this.controlBar && this.controlBar.setEditMode(), this.editModeActive = true, this.setPluginBetItemsToEditMode())) : (this.betCreditsModeChanged && (this.betCreditsModeChanged = false, this.model.setBetCreditMode(this.betCreditsModeActive), !E.BypassNoOffersCheck() && (B.IsExcludedFromPromotion('2') || B.IsExcludedFromOffers('2')) || this.appendOfferBadges(), this.betCreditsModeActive ? this.taxMessage && this.taxMessageBody.setText(StandardLocaleHelper.GetTranslation('NetReturnTax')) : this.taxMessage && this.taxMessageBody.setText(StandardLocaleHelper.GetTranslation('toReturnIncTaxLong'))), this.invalidateHeight && (this.invalidateHeight = false, Locator.validationManager.callNewContext(() => {
        ...
        insertNormalBet(e) {
            ...
            if (this.updateBetCount(t), e instanceof h ? (this.contentArea.insertBefore(e, this.betBuilderDivider), this.setHasBetBuildersState(true)) : (this.contentArea.insertBefore(e, this.singleDivider), this.setHasSingles(true)), 1 < t)
        ...
        getDefaultMultipleInstance(e) {
            return this.multipleHeaderUsed = true, this.multipleHeader || new q(e, this);
        }
        insertDefaultMultiple(e) {
            this.multipleHeaderUsed = true, this.multipleHeader = e, this.contentArea.insertBefore(this.multipleHeader, this.multiplesDivider), this.appendMultipleWrapper(), this.defaultMultiple = e, this.multiplesSuspended && this.multipleHeader.setVisible(false), 0 === this.multiples.length && this.multipleHeader.hideMoreMultiplesButton(), this.multipleHeader.createMiniBets(this.model.bets), this.multipleHeader.createMiniBets(this.model.castBets), this.animationHelper.registerMultipleHeader(this.multipleHeader, this.betslipState), this.betslipState != x.BetslipStateExpanded || e.isCast ? e.isCast && this.bets.length === this.castBets.length && (this.multipleHeader.switchToCondensedView(), this.footer.switchToCondensedView()) : (this.multipleHeader.switchToExpandedView(), this.footer.switchToExpandedView());
        }
        ...
        updateBetCreditsStake(e, t, s, i) {
            !E.BypassNoOffersCheck() && (B.IsExcludedFromPromotion('2') || B.IsExcludedFromOffers('2')) || this.appendOfferBadges(), this.footer.toggleNetReturn(e, s), 'NaN' == e ? (this.messageManager.add(new T('SplitError', R.BetCreditsSplitErrorMessage, null, 'bss-BetCreditsSplitErrorMessage'), [M.MessageContainerTypeExpanded]), this.footer.setPlaceButtonDisable()) : (this.messageManager.processMessage({ type: v.CloseBetCreditsSplitErrorMessage }), 0 < +e || 0 < +s || this.betCreditsModeActive || this.betCreditsHeader.canShowBetMessage() ? this.messageManager.add(new me(e, t, s, false, 'bss-BetCreditsFreeBetsMessage', i), [M.MessageContainerTypeCondensedAndExpanded]) : this.messageManager.processMessage({ type: v.CloseBetCreditsFreeBetsMessage }));
        }
        enableBetCredits() {
        }
        disableBetCredits() {
        ...
        displaySlip() {
            this.betslipState == x.BetslipStateExpanded && this.delegate.standardBetslipShowOverlay(false, false), this.delegate.standardBetslipSetState(1), this.animationHelper.slideSlipUp(), this.autoReviewPreference && this.autoReviewPreference.refresh();
        }
        hideSlip() {
        ...
        postErrorCleanup() {
            this.removeAllClicked = true, this.model.removeAllItems(), this.setHasSingles(true), this.setHasBetBuildersState(false), this.removeRemainingStakeLimitContainer(), this.animationHelper.closeView(() => {
        ...
        multipleRemoved(s) {
            if (s == this.defaultMultiple)
                if (this.betslipState == x.BetslipStateExpanded || this.removeAllClicked || this.multiplesSuspended || 0 == this.model.bets.length || this.betslipState == x.BetslipStateCollapsed) {
                    ...
                    C.HideElementTransition(s, true, i, () => {
                    ...
                    this.updateSkipUpdateAnimationSetting(i), this.multipleHeaderUsed = false;
        ...
        normalBetItemBetRemoved(e) {
            this.unRegisterBetItem(e), 0 == this.model.bets.length && 0 == this.model.castBets.length ? this.animationHelper.closeView(() => {
                this.messageManager.processMessage({ type: v.CloseBetslipReferralsMessage }), this.removeBetItem(e), e.parent && e.parent.removeChild(e), this.messageManager.updateDisplayState(x.BetslipStateNone), this.setSlipDisplayState(x.BetslipStateNone), this.exSelectionContainerTop.setVisible(false), this.exSelectionContainerBottom.setVisible(false), this.excludedSnglesHeader && (this.contentArea.removeChild(this.excludedSnglesHeader), this.excludedSnglesHeader = null), this.excludedSngleWrapper && (this.contentArea.removeChild(this.excludedSngleWrapper), this.excludedSngleWrapper = null), this.removeStyle('bss-StandardBetslip_ExcludedBets'), this.footer.resetFooterStake(), this.suspendBetslipComponents(), this.messageManager.dispose();
            }) : (this.removeBetItem(e), 1 == this.bets.length && (this.bets[0].hideMiniText && this.bets[0].hideMiniText(), this.updateSkipUpdateAnimationSetting(true), this.animateSlipState()), this.betslipState == x.BetslipStateExpanded && this.updateSkipUpdateAnimationSetting(true), e.getBetModel().getExcludedState() && this.checkAndRemoveExcludedSngleContainers()), 0 === this.getBetCountInfo().betbuilderCount && this.messageManager.processMessage({ type: v.CloseVoidBetWarningMessage });
        }
        unRegisterBetItem(t) {
            if (t instanceof h) {
                ...
                e || this.setHasBetBuildersState(false);
            } else
        ...
        castBetItemRemoved(e) {
            ...
            }) : this.betslipState == x.BetslipStateExpanded && this.updateSkipUpdateAnimationSetting(true);
        }
        ...
        setBetBuilderLogo(e) {
            e ? this.betBuilderLogo.setRacingLogo() : this.betBuilderLogo.resetLogoState(false);
        }
        disableSlip() {
        ...
        addBet(e) {
            this.slipReload = !e.isBoostCompataibleWithOtherSelections, this.restore(), this.removeStyle('bss-StandardBetslip_NoTransition'), this.removeAllClicked = false, this.model.addItem(e);
        }
        ...
        footerSetKeypadState(e) {
            e ? this.delegate.standardBetslipShowOverlay(false, e) : this.delegate.standardBetslipHideOverlay();
        }
        ...
        suspendMultiples() {
            this.multiplesSuspended = true, this.addStyle('bss-StandardBetslip_SuspendMultiples'), this.multipleHeader && C.HideElementTransition(this.multipleHeader), this.multipleWrapper && C.HideElementTransition(this.multipleWrapper), this.animationHelper.unRegisterMultipleHeader(), this.animationHelper.unRegisterMultipleWrapper(), this.betslipState === x.BetslipStateMultipleCondensed && this.animationHelper.condensedToCollapsedView();
        }
        unsuspendMultiples() {
            this.multiplesSuspended = false, this.removeStyle('bss-StandardBetslip_SuspendMultiples'), this.multipleHeader && this.multipleWrapper && (this.animationHelper.registerMultipleHeader(this.multipleHeader, this.betslipState), this.animationHelper.registerMultipleWrapper(this.multipleWrapper, this.betslipState), this.multipleHeader && C.ShowElementTransition(this.multipleHeader), this.multipleWrapper) && C.ShowElementTransition(this.multipleWrapper);
        }
        setAutoVoidState(e) {
        ...
        minimiseHandler() {
            m.HideKeypad(() => {
                ...
                }), this.multipleHeader.switchToCondensedView(), this.footer.switchToCondensedView(), this.setSlipDisplayState(x.BetslipStateMultipleCondensed)) : 1 == this.model.bets.length && 0 == this.model.castBets.length || 1 < this.model.bets.length && e.nonexcludedCount + e.betbuilderCount == 1 && 0 == e.castCount ? (1 == e.betbuilderCount ? this.animationHelper.collapsedSingleBetbuilderView() : this.animationHelper.condensedSingleView(true), this.messageManager.updateDisplayState(x.BetslipStateSingleCondensed), this.updateFooterModel(), Locator.validationManager.callLater(() => {
        ...
        toSlipFromReceipt() {
            var e;
            if (this.receiptMode = false, this.receiptWrapper && (this.animationHelper.unregisterReceiptHeader(this.betslipState, () => {
        ...
        removeBetItem(e) {
            ...
            var t, s = this.getBetCountInfo(), s = (this.disposed ? e.parent && e.parent.removeChild(e) : (t = this.animationHelper.getSkipAnimations() ? 0 : 0.2, e.parent && (this.removeAllClicked || this.delegate.standardBetslipIsMinimised() ? e.parent.removeChild(e) : this.betslipState == x.BetslipStateBetBuilderCondensed && e instanceof h ? (0 == s.betbuilderCount && 0 < s.allCount && this.animationHelper.betBuilderToSingleCondensedVew(e, () => {
                ...
                }), 1 == s.betbuilderCount && (e.parent.removeChild(e), this.updateSkipUpdateAnimationSetting(!s.nonexcludedCount), this.animationHelper.condensedBetBuilderBumpView())) : (this.skipAfterdocumentUpdatedAnimation ? (e.parent.removeChild(e), this.updateSkipUpdateAnimationSetting(false)) : C.HideElementTransition(e, true, t, () => {
                    this.betslipState == x.BetslipStateExpanded && this.bets.length + this.castBets.length == 1 && this.animationHelper.showBetSlip();
                }, true), 0 < s.allCount && this.betslipState !== x.BetslipStateCollapsed && this.updateSkipUpdateAnimationSetting(true))), this.bets.length || this.castBets.length || (e.parent && (e.parent.removeChild(e), this.dispose()), this.delegate.standardBetslipCollapse(() => {
                    this.removeStyle('bss-StandardBetslip_AnimateOut'), this.removeStyle('bss-StandardBetslip_NewBetBounce'), this.model.clearKeys(), this.removeAllClicked = false, this.multiplesSuspended = false, this.removeStyle('bss-StandardBetslip_SuspendMultiples'), this.removeRemainingStakeLimitContainer(), this.autoReviewPreference && (this.footer.removeChild(this.autoReviewPreference), this.autoReviewPreference = null);
                })), this.updateBetCount(this.bets.length)), null == (t = e.getBetModel()) ? undefined : t.getExcludedState());
        ...
        removeCastBetItem(e) {
            this.bets.splice(this.bets.indexOf(e), 1), this.castBets.splice(this.bets.indexOf(e), 1), this.disposed ? e.parent && e.parent.removeChild(e) : (e.parent && (this.removeAllClicked || this.delegate.standardBetslipIsMinimised() ? e.parent.removeChild(e) : C.HideElementTransition(e, true, 0.2)), this.castBets.length || this.bets.length || this.delegate.standardBetslipCollapse(() => {
                this.removeStyle('bss-StandardBetslip_AnimateOut'), this.removeStyle('bss-StandardBetslip_NewBetBounce'), this.model.clearKeys(), this.removeAllClicked = false, this.multiplesSuspended = false, this.removeStyle('bss-StandardBetslip_SuspendMultiples'), this.removeRemainingStakeLimitContainer();
        ...
        validateState() {
            ...
            1 == e && Locator.validationManager.callLater(() => {
                this.controlBar && this.castBets && (this.controlBar.removeEditMode(), s ? this.minimiseHandler() : 1 === this.castBets.length ? this.animationHelper && this.messageManager && (this.slipReload = false, this.animationHelper.showBetSlip(), this.messageManager.updateDisplayState(x.BetslipStateExpanded), this.setSlipDisplayState(x.BetslipStateExpanded), i.setHasFooterStake(false)) : this.showBetslip());
            });
        }
        appendOfferBadges(i = false) {
            this.offerBadgesContainer && this.offerBadgesWrapper && (this.offerBadgesWrapper.removeChild(this.offerBadgesContainer), this.offerBadgesContainer = null);
            ...
            if (l) {
                ...
                (e = i && i.getStake() <= r ? false : e) || this.footer.updateBonusValue('0');
                let t = true, s = true;
                for (d of l) {
                    if (d.bb) {
                        var o = d.pt;
                        if (o) {
                            t = t && o.every(e => {
                                ...
                                return null != (e = null == e ? undefined : e.some(e => e.oc === D.INCLUDED_EXTRA_TIME_OFFER)) && e;
                            }), s = s && o.every(e => {
                                var e = E.GetLocaleOffersForBetslip(null != (e = e.ob) ? e : []);
                                return null != (e = null == e ? undefined : e.some(e => e.oc === D.NINETY_PLUS_STOPPAGE_TIME_OFFER)) && e;
                            });
                            for (var h of o) {
                        ...
                        t = t && null != (a = null == c ? undefined : c.some(e => e.oc === D.INCLUDED_EXTRA_TIME_OFFER)) && a, s = s && null != (a = null == c ? undefined : c.some(e => e.oc === D.NINETY_PLUS_STOPPAGE_TIME_OFFER)) && a;
                    }
                    if (d.ob) {
                ...
                for (g of n)
                    'EP' === g.oc ? f.push({
                        ...
                        offerTextMini: C && E.GetBadgeTranslation(g.oc, true) || '',
                ...
                if (_.length) {
                    var i = 'EXTEXC' != _[0].oc && 2 <= this.bets.length, k = {
                            ...
                            offerTextMini: i && E.GetBadgeTranslation(_[0].oc, true) || '',
                ...
                if (B.length) {
                    var v = {
                        ...
                        offerTextMini: !(this.bets.length < 2) && E.GetBadgeTranslation(B[0].oc, true) || '',
                ...
                if (y.length) {
                    var T = {
                        ...
                        offerTextMini: !(this.bets.length < 2) && E.GetBadgeTranslation(y[0].oc, true) || '',
        ...
        expandToShowMultiples() {
            this.betslipState !== x.BetslipStateExpanded && (this.footer.hideKeypad(), this.delegate.standardBetslipShowOverlay(g.GetBetCount() < 0, false), this.multipleHeader && this.multipleHeader.switchToExpandedView(), this.messageManager.updateDisplayState(x.BetslipStateExpanded), this.animationHelper.condensedToExpandedView(() => {
        ...
        betBuilderBetItemShowOptions() {
            this.betslipState != x.BetslipStateExpanded && (this.footer.hideKeypad(), this.delegate.standardBetslipShowOverlay(0 < g.GetBetCount() && 3 != this.currentState, false), this.updateSkipUpdateAnimationSetting(true), this.animationHelper.expandedSingleBetbuilderView(), this.messageManager.updateDisplayState(x.BetslipStateExpanded), this.setSlipDisplayState(x.BetslipStateExpanded));
        }
        multipleHeaderRemoveButtonClicked() {
            this.removeAllClicked = true, this.model.removeAllItems();
        }
        ...
        afterDocumentUpdated(e) {
            this.updateFooterModel(), this.unsuspendBetslipComponents(), this.skipAfterdocumentUpdatedAnimation || this.animateSlipState(), this.updateSkipUpdateAnimationSetting(false), this.slipTypeChanged && (this.slipTypeChanged = false, Locator.validationManager.callNewContext(() => {
        ...
        showBetslip() {
            this.slipReload = false, this.delegate.standardBetslipShowOverlay(false, false), this.animationHelper.showBetSlip(), this.messageManager.updateDisplayState(x.BetslipStateExpanded), this.setSlipDisplayState(x.BetslipStateExpanded), this.updateSkipUpdateAnimationSetting(true), this.slipTypeChanged = true;
        }
        hideForSiteActivity() {
        ...
        animateSlipState() {
            if (3 != this.currentState) {
                var e = this.getBetCountInfo();
                if (this.slipReload)
                    this.setSlipDisplayState(this.animationHelper.restoreView(this.isCompatibleForCondensedView(), u.Standard)), this.multipleHeader && this.betslipState == x.BetslipStateMultipleCondensed && this.multipleHeader.switchToCondensedView(), this.messageManager.updateDisplayState(this.betslipState), this.slipReload = false;
                else if (0 === this.model.bets.length && 1 === this.model.castBets.length && this.model.castBets[0].betTypeLookupKey != f.AusMultiLegBet)
                    this.animationHelper.condensedToExpandedView(), this.footer.switchToCondensedView(), this.messageManager.updateDisplayState(x.BetslipStateExpanded), this.setSlipDisplayState(x.BetslipStateExpanded), i.setHasFooterStake(false);
        ...
        updateSkipUpdateAnimationSetting(e) {
            e && g.HasCookieOverride ? (3 == this.currentState && (this.toSlipFromReceipt(), this.currentState = 1, this.delegate.standardBetslipHideOverlay()), g.HasCookieOverride = false, this.skipAfterdocumentUpdatedAnimation = false) : this.skipAfterdocumentUpdatedAnimation = e;
        }
        ...
        toSlipReceipt(e) {
            if (!this.receiptContent) {
                ...
                if (H.isAutoAcceptAllSelected) {
                    H.isAutoAcceptAllSelected = false;
                    let e = new ke(() => {
        ...
        hasExcludededStakedBets() {
            ...
            for (var t of this.bets) {
                var s = t.getBetModel();
                s.getExcludedState() && (t.hasStake ? e = e || true : s.excludedOnReceipt());
            }
            return e;
        }
            ...
            return new oe({
                receiptContentDoneClicked: () => {
                    this.animationHelper.closeView(() => {
                        this.delegate.standardBetslipCollapse(), this.delegate.standardBetslipHideOverlay(), this.removeAllClicked = true, this.model.removeAllItems(), this.currentState = 0, this.dispose();
                    });
                },
                shareBetClicked: () => {
