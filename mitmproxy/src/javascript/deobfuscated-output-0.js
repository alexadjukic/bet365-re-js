(() => {
  ...
  var o = [e => {
      ...
      t.isHLSStreamingAvailable = (e, o) => {
        ...
        if ("undefined" == typeof MediaSource && undefined === window.WebKitMediaSource) return !1;
        ...
        const s = !!n.length;
        return n.cssText = "", s;
      })("-webkit-overflow-scrolling", "touch", undefined, !0), t.MOBILE_DEVICE_PREFIX = "M", t.TABLET_DEVICE_PREFIX = "T";
      let d;
      ...
      t.AccessibilityContextProvider = ({
        ...
        const [t, o] = (0, i.useState)(!1),
          enableAccessibility = () => {
            var e, r, i, n, s;
            t || ((null === (e = window.ns_gen5_ui_accessibility) || undefined === e ? undefined : e.AccessibilityController) && (null === (i = (r = window.ns_gen5_ui_accessibility.AccessibilityController).RegisterFocusStyles) || undefined === i || i.call(r, ":focus { box-shadow: 0 0 0 1px #ccc inset; outline: 1px solid transparent; }"), null === (s = (n = window.ns_gen5_ui_accessibility.AccessibilityController).EnableAccessibility) || undefined === s || s.call(n)), o(!0));
          };
