(() => {
  ...
  var o = [e => {
      ...
      const s = navigator,
        a = ["", "-webkit-", "-moz-", "-o-", "-ms-"],
        c = null !== (r = null === (o = s.userAgentData) || void 0 === o ? void 0 : o.brands) && void 0 !== r ? r : [],
      ...
      t.type = (() => {
        ...
        return (() => {
          const searchBrands = e => {
            for (const t of c) if (t.brand.toLowerCase().indexOf(e) > -1) return !0;
            return !1;
          };
      ...
      t.isBrowserShareAvailable = () => void 0 !== navigator.share, t.isTHEOliveStreamingAvailable = (() => {
        ...
        if (-1 !== l.indexOf("iPhone") || -1 !== l.indexOf("iPad")) {
          const e = /OS ([0-9]{1,2}\.[0-9]{1,2})/.exec(l.replace("_", ".")),
            t = parseFloat(null == e ? void 0 : e[1]);
          return !t || isNaN(t) ? ($log("Browser: Unable to parse OS version"), !1) : {
            deviceType: i.iOS,
            version: t
          };
        }
      ...
      t.meetsMinimumOSVersion = (e, o) => !t.getOSDetails || !(t.getOSDetails.deviceType === i.Android && parseFloat(o) > t.getOSDetails.version || t.getOSDetails.deviceType === i.iOS && parseFloat(e) > t.getOSDetails.version), t.isFantasySportsAvailable = (() => {
        if (-1 === l.indexOf("iPhone") && -1 === l.indexOf("iPad")) return !0;
        const e = getIOSVersion();
      ...
      t.isHLSNativeStreamingAvailable = (e, o) => {
        if (!e && t.type !== t.vendor.SAFARI) return !1;
        if (e && o) return !1;
      ...
      t.isHLSStreamingAvailable = (e, o) => {
        if ((0, t.isHLSNativeStreamingAvailable)(e, o)) return !0;
        if ("undefined" == typeof MediaSource && void 0 === window.WebKitMediaSource) return !1;
        const r = "undefined" != typeof MediaSource ? MediaSource : window.WebKitMediaSource;
        return void 0 !== r && "function" == typeof r.isTypeSupported && r.isTypeSupported('video/mp4; codecs="avc1.42E01E,mp4a.40.2"');
        ...
        const s = !!n.length;
        return n.cssText = "", s;
      })("-webkit-overflow-scrolling", "touch", void 0, !0), t.MOBILE_DEVICE_PREFIX = "M", t.TABLET_DEVICE_PREFIX = "T";
      let d;
      t.getDeviceStylePrefix = () => {
        var e, o, r, i;
        if (d) return d;
        const n = null !== (i = null === (r = null === (o = null === (e = window.ns_gen5_ui) || void 0 === e ? void 0 : e.Application) || void 0 === o ? void 0 : o.currentApplication) || void 0 === r ? void 0 : r.width) && void 0 !== i ? i : window.innerWidth;
      ...
      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.AccessibilityContext = void 0;
      const r = o(0);
      t.AccessibilityContext = (0, r.createContext)(void 0), t.AccessibilityContext.displayName = "AccessibilityContext";
    }, (e, t, o) => {
      "use strict";

      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.BrowserContext = void 0;
      const r = o(0);
      t.BrowserContext = (0, r.createContext)(void 0), t.BrowserContext.displayName = "PostBootReactLib.BrowserContext";
    }, (e, t, o) => {
      "use strict";

      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.LoginContext = void 0;
      const r = o(0);
      t.LoginContext = (0, r.createContext)(void 0), t.LoginContext.displayName = "PostBootReactLib.LoginContext";
    }, (e, t, o) => {
      "use strict";

      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.PasscodeContext = void 0;
      const r = o(0);
      t.PasscodeContext = (0, r.createContext)(void 0), t.PasscodeContext.displayName = "PostBootReactLib.PasscodeContext";
    }, (e, t) => {
      "use strict";
      ...
      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.passcodeStore = void 0;
      const o = new Set();
      let r = {
        passcodeState: null,
        isPasscodeSupported: !1,
        isPasscodeEnabled: !1
      };
      t.passcodeStore = {
        setState(e) {
      ...
      const n = "g5-Application-scrolllock",
        ...
        lockScrolling = () => {
          ...
          r = document.documentElement.scrollTop, e.style.top = `-${r}px`, e.classList.add(n), o = !0;
        },
        unlockScrolling = () => {
          if (!o) return;
          const e = getAppElement();
          o = !1, e.style.top = "", e.classList.remove(n), window.scrollTo(0, r), r = 0;
        };
      t.getScrollLock = () => ({
        scrollPos: r,
        isScrollLocked: o,
      ...
      const touchStartHandler = () => {
          if (n = !0, s = Date.now(), i) {
            i = !1, o && o.setItem("ns_webconsolelib_util.inputType", "touch");
            for (const e of r) e.mouseModeDisabled();
            null == a || a.RecordMouseMode(!1);
          }
        },
        touchEndHandler = () => {
          s = Date.now();
        ...
        mouseMoveHandler = () => {
          if (!(i || Date.now() - s < 1500)) {
            s = 0, n = !1, i = !0, o && o.setItem("ns_webconsolelib_util.inputType", "mouse");
            for (const e of r) e.mouseModeEnabled();
            null == a || a.RecordMouseMode(!0);
          }
        };
      t.mouseDetector = {
        addDelegate: e => {
        ...
        initialise: e => {
          if (c) return;
          if (a = e, null == a ? void 0 : a.Replaying) return;
          let t;
          o = window.safeSessionStorage, c = !0, o && (t = o.getItem("ns_webconsolelib_util.inputType")), t ? (n = "touch" === t, i = "mouse" === t) : (n = (() => {
            if ("PointerEvent" in window && "maxTouchPoints" in navigator) {
              if (navigator.maxTouchPoints > 0) return !0;
            } else {
              if (window.matchMedia && window.matchMedia("(any-pointer:coarse)").matches) return !0;
              if ("TouchEvent" in window || "ontouchstart" in window) return !0;
            }
            return !1;
      ...
      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.BrowserFeatureDetection = void 0;
      const r = o(2);
      ...
      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.useBrowserContext = void 0;
      const r = o(0),
        i = o(4);
      t.useBrowserContext = () => {
        const e = (0, r.useContext)(i.BrowserContext);
        return void 0 === e && $assert && $assert(e, "useBrowserContext must be used within a BrowserContextProvider"), e;
      };
    }, (e, t, o) => {
      "use strict";
      ...
      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.useLoginContext = void 0;
      const r = o(0),
        i = o(5);
      t.useLoginContext = () => {
        const e = (0, r.useContext)(i.LoginContext);
        return void 0 === e && $assert && $assert(e, "useLoginContext must be used within a LoginContextProvider"), e;
      };
    }, (e, t, o) => {
      "use strict";
      ...
      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.usePasscode = void 0;
      const r = o(0),
        i = o(6);
      t.usePasscode = () => {
        const e = (0, r.useContext)(i.PasscodeContext);
        return void 0 === e && $assert && $assert(e, "usePasscode must be used within a PasscodeContextProvider"), Object.assign({}, e);
      };
    }, (e, t) => {
      "use strict";
      ...
      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.AuthenticationTypes = void 0, function (e) {
      ...
      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.PasscodeStates = void 0, function (e) {
      ...
      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.AccessibilityContextProvider = void 0;
      const r = o(1),
        i = o(0),
        n = o(3);
      t.AccessibilityContextProvider = ({
        ...
        const [t, o] = (0, i.useState)(!1),
          enableAccessibility = () => {
            var e, r, i, n, s;
            t || ((null === (e = window.ns_gen5_ui_accessibility) || void 0 === e ? void 0 : e.AccessibilityController) && (null === (i = (r = window.ns_gen5_ui_accessibility.AccessibilityController).RegisterFocusStyles) || void 0 === i || i.call(r, ":focus { box-shadow: 0 0 0 1px #ccc inset; outline: 1px solid transparent; }"), null === (s = (n = window.ns_gen5_ui_accessibility.AccessibilityController).EnableAccessibility) || void 0 === s || s.call(n)), o(!0));
          };
        return (0, i.useEffect)(() => (window.bet365.messageBus.registerRequestHandler("accessibility.enable", ({
          enabled: e
        }) => {
          (e => {
            e ? enableAccessibility() : o(!1);
          })(e);
        }), () => {
      ...
      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.BrowserContextProvider = void 0;
      const r = o(1),
        i = o(4),
        n = o(2);
      ...
      Object.defineProperty(t, "__esModule", {
        value: !0
      }), t.PasscodeContextProvider = void 0;
      const r = o(1),
        i = o(0),
        n = o(6),
        s = o(10);
  ...
  (() => {
    ...
    Object.defineProperty(e, "__esModule", {
      value: !0
    }), e.PasscodeContextProvider = e.LoginContextProvider = e.BrowserContextProvider = e.AccessibilityContextProvider = e.ErrorFallback = e.AccessibilityAnchor = e.mouseDetector = e.getScrollLock = e.getML = e.browser = e.PasscodeStates = e.OddsType = e.LoginType = e.AuthenticationTypes = e.passcodeStore = e.oddsStore = e.loginStore = e.ccrmStore = e.usePasscode = e.useOdds = e.useLoginContext = e.useCCRM = e.useBrowserContext = e.MouseDetector = e.BrowserFeatureDetection = e.passcodeStoreGen5 = e.oddsStoreGen5 = e.loginStoreGen5 = e.getScrollLockGen5 = e.ccrmStoreGen5 = e.PasscodeContext = e.LoginContext = e.BrowserContext = e.AccessibilityContext = void 0;
